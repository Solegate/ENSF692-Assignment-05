# web_data_app.py
# Modified by: Maheesha_Munasinghe, ENSF 692 P24
...
def hello_there(name):
    ...
    content = "Hello there, " + clean_name + "! Welcome to Assignment 6. It's " + formatted_now
    return content
...
def learn():
    ...
    learning = "Learning Python opens up a world of possibilities in various domains of technology"
    return learning
